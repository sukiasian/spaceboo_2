...
ErrorController.sendErrorProd = (err, res) => {
    if (err.isOperational) {
        this.logger.log(enums_1.LoggerLevels.ERROR, [err, enums_1.ErrorMessages.APPLICATION_ERROR]);
        ...
        this.logger.log(enums_1.LoggerLevels.ERROR, [err, enums_1.ErrorMessages.UNKNOWN_ERROR]);
        res.status(err.statusCode).json({
            status: err.status,
