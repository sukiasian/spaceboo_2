...
exports.closeTestEnv = exports.openTestEnv = exports.createTokenAndSign = exports.createCustomDate = exports.createSpaceData = exports.testUserValidationByMessages = exports.createInvalidUserData = exports.createUserData = exports.createApplicationInstance = exports.clearDb = exports.closeDb = exports.closeServer = exports.startDb = exports.startServer = void 0;
...
const createCustomDate = (dateRawValue, timezone) => {
    ...
    return `${year}-${month}-${day}T${hours}:${minutes}:${seconds}.${milliseconds}${UtilFunctions_1.default.timezoneParser(timezone)}`;
};
exports.createCustomDate = createCustomDate;
