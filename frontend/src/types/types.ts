...
export enum ReduxCommonActions {
    ...
    SET_MY_APPOINTMENTS_PAGE_IS_LOADED_TO_TRUE = 'SET_MY_APPOINTMENTS_PAGE_IS_LOADED_TO_TRUE',
    SET_MY_APPOINTMENTS_PAGE_IS_LOADED_TO_FALSE = 'SET_MY_APPOINTMENTS_PAGE_IS_LOADED_TO_FALSE',
}
