...
export enum SagaTasks {
    ...
    REQUEST_SPACE_BY_ID = 'REQUEST_SPACE_BY_ID',
    REQUEST_USER_SPACES = 'REQUEST_USER_SPACES',
    ...
    REQUEST_SEND_VERIFICATION_CODE = 'REQUEST_SEND_VERIFICATION_CODE',
    REQUEST_CHECK_VERIFICATION_CODE = 'REQUEST_CHECK_VERIFICATION_CODE',
