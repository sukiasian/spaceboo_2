...
export enum ReduxAppointmentActions {
    SET_FETCH_USER_OUTDATED_APPOINTMENTS_SUCCESS_RESPONSE = 'SET_FETCH_USER_OUTDATED_APPOINTMENTS_SUCCESS_RESPONSE',
    SET_FETCH_USER_ACTIVE_APPOINTMENTS_FAILURE_RESPONSE = 'SET_FETCH_USER_ACTIVE_APPOINTMENTS_FAILURE_RESPONSE',
    SET_FETCH_USER_UPCOMING_APPOINTMENTS_SUCCESS_RESPONSE = 'SET_FETCH_USER_UPCOMING_APPOINTMENTS_SUCCESS_RESPONSE',
    SET_FETCH_USER_OUTDATED_APPOINTMENTS_FAILURE_RESPONSE = 'SET_FETCH_USER_OUTDATED_APPOINTMENTS_FAILURE_RESPONSE',
    SET_FETCH_USER_ACTIVE_APPOINTMENTS_SUCCESS_RESPONSE = 'SET_FETCH_USER_ACTIVE_APPOINTMENTS_SUCCESS_RESPONSE',
    SET_FETCH_USER_UPCOMING_APPOINTMENTS_FAILURE_RESPONSE = 'SET_FETCH_USER_UPCOMING_APPOINTMENTS_FAILURE_RESPONSE',
}
...
export enum SagaTasks {
    ...
    FETCH_USER_OUTDATED_APPOINTMENTS = 'FETCH_USER_OUTDATED_APPOINTMENTS',
    FETCH_USER_ACTIVE_APPOINTMENTS = 'FETCH_USER_ACTIVE_APPOINTMENTS',
    FETCH_USER_UPCOMING_APPOINTMENTS = 'FETCH_USER_UPCOMING_APPOINTMENTS',
